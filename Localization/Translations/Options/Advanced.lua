...
local advancedOptionsLocales = {
    ...
    ["When enabled, Questie will hotfix vanilla UI bugs."] = {
        ...
        ["koKR"] = "활성화되면 퀘스트 위치 힌트 플러그인이 클래식 인터페이스 오류를 핫픽스합니다.",
    ...
    ["When this is checked, the ID of items will shown in tooltips."] = {
        ...
        ["koKR"] = "활성화하면 아이템 ID가 툴팁에 표시됩니다.",        ["esMX"] = "Si está marcado, la identificación de los artículos se mostrará en los tooltips.",
        ["enUS"] = true,
        ["zhCN"] = false,
    ...
    ["When this is checked, the ID of objects will be shown in tooltips. These are guesses and only show the first matching ID in the QuestieDB."] = {
        ...
        ["koKR"] = "활성화하면 아이템 ID가 툴팁에 표시됩니다. QuestieDB에서 일치하는 첫 번째 ID만 표시되며, 이는 추측입니다.",        ["esMX"] = "Si está marcado, la identificación de los objetos se mostrará en los tooltips. Estas son conjeturas y solo muestran la primera identificación coincidente en QuestieDB.",
        ["enUS"] = true,
        ["zhCN"] = false,
